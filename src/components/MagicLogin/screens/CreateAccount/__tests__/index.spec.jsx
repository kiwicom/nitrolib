...
describe("#CreateAccount", () => {
  ...
  it("check password hinter for different password", () => {
    ...
    passwordField.simulate("change", { target: { value: "PasswordMedium12" } });
    expect(passwordHint.text()).toEqual("account.password_validation.strength_label.medium");

    passwordField.simulate("change", {
      target: { value: "P4sw0rdStr0ng1337xXxP0Wer" },
    });
    expect(passwordHint.text()).toEqual("account.password_validation.strength_label.strong");
  });
