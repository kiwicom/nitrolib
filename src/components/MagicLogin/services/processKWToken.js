...
import { MAGIC_LINK_USED, MAGIC_LINK_EXPIRED, MAGIC_LINK_FAILED } from "../consts/events";
...
const processKWToken = async (): Promise<?AuthUser> => {
  const kwAuthToken = jsCookie.get(KW_AUTH_TOKEN);
