  ...
  const getFirstItemInfo = (isCurrent, priceValue) =>
    isCurrent ? (
      <Text
        ...
        weight="bold"
        type="secondary"
        dataTest="BaggagePickerBRBRedesign-OptionItem-Current"
      >
        <Translate t="baggage_modal.select.current" />
      </Text>
    ) : (
      <Text element="span" weight="bold" dataTest="BaggagePickerBRBRedesign-OptionItem-Price">
    ...
    <ThemeConsumer>
      {({ rtl }) => (
        <Stack
          ...
          shrink
          align="start"
          dataTest={`BaggagePickerBRBRedesign-OptionItem-${category}`}
          spacing="none"
